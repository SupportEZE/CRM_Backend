...
import { toObjectId, commonFilters, appCommonFilters } from 'src/common/utils/common.utils';
...
export class AppPaymentService {
    ...
    async read(req: Request, params: any): Promise<any> {
        try {
            let match: any = { is_delete: 0, org_id: req['user']['org_id'], customer_id: req['user']['_id'] };
